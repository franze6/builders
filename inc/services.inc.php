<div class="services_section_block">
    ...
    <div class="single_block">
        <article class="services_section_item" itemscope="" itemtype="http://schema.org/Article">
            <a href="/price/#recycling" class="animation_img">
                <span class="overlay"></span>
                <img src="/img/services/recycling.jpg" alt="Работы по утилизации отходов" title="Работы по утилизации отходов" itemprop="image">
                <span class="link"><i class="fa fa-link"></i></span>
            </a>
            <div class="description">
                <h2>
